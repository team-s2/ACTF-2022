...
enum class Instruction: uint8_t
{
	...
	KECCAK256 = 0x50,		///< compute KECCAK-256 hash

	ADDRESS = 0x40,		///< get address of currently executing account
	...
	RETURNDATASIZE = 0x4d,	///< get size of return data buffer
	RETURNDATACOPY = 0x4e,	///< copy return data in current environment to memory
	EXTCODEHASH = 0x4f,	///< get external code hash (from another contract)

	BLOCKHASH = 0x20,	///< get hash of most recent complete block
	...
	POP = 0x30,			///< remove item from stack
	...
	PUSH1 = 0x90,		///< place 1 byte item on stack
	...
	DUP1 = 0x70,		///< copies the highest item in the stack to the top of the stack
	...
	SWAP1 = 0x80,		///< swaps the highest and second highest value on the stack
	...
	LOG0 = 0x60,		///< Makes a log entry; no topics.
	LOG1,				///< Makes a log entry; 1 topic.
	LOG2,				///< Makes a log entry; 2 topics.
	LOG3,				///< Makes a log entry; 3 topics.
	LOG4,				///< Makes a log entry; 4 topics.

	CREATE = 0x10,		///< create a new account with associated code
	CALL,				///< message-call into an account
	CALLCODE,			///< message-call with another account's code only
	RETURN,				///< halt execution returning output data
	DELEGATECALL,		///< like CALLCODE but keeps caller's value and sender
	CREATE2 = 0x15,		///< create new account with associated code at address `sha3(0xff + sender + salt + init code) % 2**160`
	STATICCALL = 0x1a,	///< like CALL but disallow state modifications

	REVERT = 0x1d,		///< halt execution, revert state and return output data
	INVALID = 0x1e,		///< invalid instruction for expressing runtime errors (e.g., division-by-zero)
	SELFDESTRUCT = 0x1f	///< halt execution and register account for later deletion
};
